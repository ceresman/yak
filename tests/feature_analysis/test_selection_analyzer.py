...
def sample_data():
    ...
    # Generate random genotypes with sample IDs as index
    ...
    # Generate random phenotypes with trait_value and population
    phenotypes = pd.DataFrame({
        'trait_value': np.random.uniform(0, 1, size=n_samples),
